                ...
                {#INCLUDE:menuPanelAdmin}
                    ...
                    <div class='quadros'>
                      ...
                      <form action="?page=paneladmin&amp;option=ADD_NOTICE&amp;Write=true" method="post" name="noticeFrom">
                       	...
                       	<em>Notícia:</em><br /><textarea name="content" id="content">Aceita codigos HTML.</textarea><br />
                        <input type="submit" value="Adicionar." class="button" onclick="noticeFrom.content.value = base64Encode(noticeFrom.content.value);" />
                      </form>
                    </div>
                    {#RESULTTPL}
                </div>
