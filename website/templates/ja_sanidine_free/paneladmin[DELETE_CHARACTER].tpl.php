...
<div id="ja-content-bot" class="clearfix">
                            ...
                            <h1 style="margin-top: 20px; margin-bottom: 26px;">Deletar personagem</h1>
                            
                            	<div id="etc">
                                      <form action="?page=paneladmin&amp;option=DELETE_CHARACTER&amp;Write=true" method="post">
                                        <em>Personagem:</em> <input name="character" type="text" class="inputbox" value="" /> <input type="submit" value="Deletar personagem." class="button" />
                                  </form>
                       		  </div>
                                    <div style="margin-top: 10px;" id="etc">
                                    {#RESULTTPL}
                                    </div>
                            	</div>
                            </div>
