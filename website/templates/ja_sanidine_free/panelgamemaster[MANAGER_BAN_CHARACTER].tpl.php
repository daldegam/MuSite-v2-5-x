				...
				<div id="ja-content">
					<div id="ja-content-top">
						<div id="ja-content-bot" class="clearfix">
                           ...
                           <div id="etc">
                            <h1 style="margin-top: 20px; margin-bottom: 26px;">Banir / Desbanir personagem</h1>
                    			<div id="classe_change">
                                <form action="?page=panelgamemaster&amp;option=MANAGER_BAN_CHARACTER&amp;Write=true" method="post">
                                    ...
                                    <input type="submit" value="Salvar." class="button" style="margin-top: 6px;" />
                                  </form>
                                </div>
                                <div id="etc" style="margin-top: 10px;">
                                	{#RESULTTPL}
                                </div>
                            </div>
