...
<div id="ja-content-bot" class="clearfix">
                            ...
                            <h1 style="margin-top: 20px; margin-bottom: 26px;">Deletar conta</h1>
                            
                            	<div id="etc">
                                        <form action="?page=paneladmin&amp;option=DELETE_ACCOUNT&amp;Write=true" method="post">
                                        <em>Login:</em> <input name="account" type="text" class="inputbox" value="" /> <input type="submit" value="Deletar contas." class="button" />
                                  </form>
                       		  </div>
