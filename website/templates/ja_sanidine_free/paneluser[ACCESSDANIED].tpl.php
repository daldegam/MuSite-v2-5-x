					...
					<div id="ja-content-top">
						<div id="ja-content-bot" class="clearfix">
							...
							<div id="ja-current-content" class="clearfix">
                            	...
                            	<h1 style="margin-top: 20px; margin-bottom: 26px;">Acesso negado</h1>
                                <div class="qdestaques" style="margin-bottom: 10px;">Você não pode usar essas opções no seu plano atual.</div>
                           	  </div>
                            </div>
						</div>
					</div>
