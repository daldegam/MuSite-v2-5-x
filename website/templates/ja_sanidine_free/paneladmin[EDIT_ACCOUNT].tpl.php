...
<div id="ja-content-bot" class="clearfix">
                            ...
                            <h1 style="margin-top: 20px; margin-bottom: 26px;">Editar conta</h1>
                            
                            	<div id="etc">
                                  <form action="?page=paneladmin&amp;option=EDIT_ACCOUNT&amp;Write=true" method="post">
                       				<em>Login:</em> <input name="account" type="text" value="" class="inputbox" /> <input type="submit" value="Carregar dados." class="button" />
                      			</form>
                       		  </div>
