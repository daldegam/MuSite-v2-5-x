				...
				<div id="ja-content">
					<div id="ja-content-top">
						<div id="ja-content-bot" class="clearfix">
                            ...
                            <h1 style="margin-top: 20px; margin-bottom: 26px;">Alterar Nick</h1>
                      ...
                      <tr>
                       ...
                       <td>
                        <select name='personagem' class="inputbox" onchange="location='?page=paneluser&amp;option=CHANGE_NICK&amp;character='+this.options[this.selectedIndex].value">
                    ...
                    <div style="margin-top: 16px; margin-bottom: 16px;" id="classe_change">
