{#INCLUDE:header} 
        ...
        <div id="subright">
            ...
            <div class="sub_wrap">
                ...
                <div id="etc">
                    <h1 style="margin-bottom: 25px;">Vantagens de ser um player vip</h1>
                            
                    <div class="legend" style="margin-bottom: 26px;">
                        <h3 class="legend-title"><span style="font-size: 13px;">Opções do painel de usuário</span></h3>
                        <div style="margin-bottom: 8px; margin-top: 10px;">
                            <table border="0" width="100%">
                             ...
                             <tr>
                              <td align="left" ><strong>Alterar dados</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Limpar Bau</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Bau Duplo</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Log de compras</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Alterar personal ID</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Resetar Personagem</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Transferir Resets</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Limpar PK</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Distribuir Pontos</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Mover Personagem</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Mudar Nick</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Mudar Classe</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Redistribuir Pontos</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Limpar Inventário</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Abrir Denuncias</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Abrir Pedidos (Ticket)</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Ver Pedidos (Ticket)</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Enviar SMS para os ADMs</strong></td>
                    ...
                    <div class="legend" style="margin-bottom: 26px;">
                        <h3 class="legend-title"><span style="font-size: 13px;">Opções de 0 a 10 resets</span></h3>
                        <div style="margin-bottom: 8px; margin-top: 10px;">
                            <table border="0" width="100%">
                             <tr>
                              <td align="center" ><strong>Nome</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Level para resetar</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Zen para resetar</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Pontos por reset</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Apaga itens ao resetar</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Apaga magias ao resetar</strong></td>
                             ...
                             <tr>
                              <td align="left" ><strong>Apaga quests ao resetar</strong></td>
                    ...
                    <div class="legend" style="margin-bottom: 26px;">
                        <h3 class="legend-title"><span style="font-size: 13px;">Opções de 11 a 50 resets</span></h3>
                        <div style="margin-bottom: 8px; margin-top: 10px;">
                            <table border="0" width="100%">
                             <tr>
                              <td align="center" ><strong>Nome</strong></td>
                    ...
                    <div class="legend" style="margin-bottom: 26px;">
                        <h3 class="legend-title"><span style="font-size: 13px;">Opções de 51 a 100 resets</span></h3>
                        <div style="margin-bottom: 8px; margin-top: 10px;">
                            <table border="0" width="100%">
                             <tr>
                              <td align="center" ><strong>Nome</strong></td>
                    ...
                    <div class="legend" style="margin-bottom: 26px;">
                        <h3 class="legend-title"><span style="font-size: 13px;">Opções de 101 a 150 resets</span></h3>
                        <div style="margin-bottom: 8px; margin-top: 10px;">
                            <table border="0" width="100%">
                             <tr>
                              <td align="center" ><strong>Nome</strong></td>
                    ...
                    <div class="legend" style="margin-bottom: 26px;">
                        <h3 class="legend-title"><span style="font-size: 13px;">Opções de 151 a 200 resets</span></h3>
                        <div style="margin-bottom: 8px; margin-top: 10px;">
                            <table border="0" width="100%">
                             <tr>
                              <td align="center" ><strong>Nome</strong></td>
                    ...
                    <div class="legend" style="margin-bottom: 26px;">
                        <h3 class="legend-title"><span style="font-size: 13px;">Opções de 201 a 300 resets</span></h3>
                        <div style="margin-bottom: 8px; margin-top: 10px;">
                            <table border="0" width="100%">
                             <tr>
                              <td align="center" ><strong>Nome</strong></td>
                    ...
                    <div class="legend" style="margin-bottom: 26px;">
                        <h3 class="legend-title"><span style="font-size: 13px;">Opções de resets após 301 resets</span></h3>
                        <div style="margin-bottom: 8px; margin-top: 10px;">
                            <table border="0" width="100%">
                             <tr>
                              <td align="center" ><strong>Nome</strong></td>
