    ...
    document.cadastro.submit(); 
        ...
        <div id="subright">
            ...
            <div class="locationtitle">
                <div class="location">
                    <a class="home" href="?">INÍCIO</a> &gt; <strong>CADASTRO</strong>
                </div>
            ...
            <div class="sub_wrap">
                <div style="margin-bottom: 25px;" class="quadrosOut">{#RESULT_REGISTER}</div>
                ...
                <form name='cadastro' action='?page=register&write=true' method='post'>
                  ...
                  ?>   
                     ...
                     <table width='100%' border='0'>
                         <tr>
                          <td colspan='3' align="center"><iframe src='templates/sunonline/termos.tpl.php' width='500' height='180'></iframe></td>
                         </tr>
                         </table>
                        </div>
                       </div>
