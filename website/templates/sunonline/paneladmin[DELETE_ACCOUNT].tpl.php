        ...
        <div id="subright">
            ...
            <div class="sub_wrap">
                <div id="etc">
                    ...
                    <h1 style="margin-top: 20px;">Deletar conta</h1>
                    ...
                    <div class="legend" style="margin-top: 25px; padding: 10px;">
                      <h3 class="legend-title"><span style="font-size: 13px;">Preencha os dados abaixo:</span></h3>
                          <form action="?page=paneladmin&amp;option=DELETE_ACCOUNT&amp;Write=true" method="post">
                               <em>Login:</em> <input name="account" type="text" value="" class="inputbox" /> <input type="submit" value="Deletar contas." class="button" />
                          </form>
